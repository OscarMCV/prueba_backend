...
urlpatterns = [
    ...
    path('courses/<str:course_id>/lessons/<str:lesson_id>/', views.LessonDetail.as_view()),
    #Retrieve all the questions (and their id's) of a given ID lesson, also is able to delete it
    path('courses/<str:course_id>/lessons/<str:lesson_id>/questions/<str:question_id>/', views.QuestionDetail.as_view()),
    #Retrieve all the answers of a question, and create new ones

    path('courses/lessons/', views.LessonView.as_view()),
